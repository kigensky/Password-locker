...
class TestClass(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.new_user = User('ethan','2021')

    def test_init(self):
        """
        test case to chek if the object has been initialized correctly
        """
        self.assertEqual(self.new_user.username,'ethan')
...
class TestCredentials(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.new_credential = Credentials('facebook','ethan','1234')
    def test_init(self):
        """
        Test case to check if a new Credentials instance has been initialized correctly
        """
        self.assertEqual(self.new_credential.account,'facebook')
        self.assertEqual(self.new_credential.userName,'ethan')
    ...
    def test_save_many_accounts(self):
        ...
        '''
        self.new_credential.save_details()
        test_credential = Credentials("Twitter","ethan","1234") 
    ...
    def test_credential_exist(self):
        ...
        """
        self.new_credential.save_details()
        the_credential = Credentials("Twitter", "ethan", "1234")  
